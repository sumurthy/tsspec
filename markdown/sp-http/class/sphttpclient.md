...
|[`post(url,configuration,options)`](post-sphttpclient.md)     | `public` | [`Promise`](../../es6-promise.api/class/promise.md)<[`SPHttpClientResponse`](../../sp-http/class/sphttpclientresponse.md)> | Calls fetch(), but sets the method to 'POST'. |
